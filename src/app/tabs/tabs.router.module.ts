    ...
    children: [
      {
        ...
        children: [
          {
            path: '',
            loadChildren: () => import('../pages/user-pages/categories/categories.module').then(m => m.CategoriesPageModule)
          },
          {
            path:'new-plan',
            loadChildren:()=>import('../pages/user-pages/new-plan/new-plan.module').then(m=>m.NewPlanModule)
          },
          {
            path: 'fashion',
